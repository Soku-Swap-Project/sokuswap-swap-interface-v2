    ...
    <div className="flex flex-col gap-4">
      <div className="grid gap-2">
        <div className="flex items-center">
          <Typography variant="xs" weight={700} className="text-lightBlue">
        ...
        <div className="flex items-center space-x-2">
          <div
            className={classNames(
              slippageError === SlippageError.INVALID_INPUT
                ...
                ? 'border-blue'
                : 'border-light-800',
              'h-[36px] bg-white flex items-center hover_shadow px-2 rounded'
            )}
            tabIndex={-1}
          >
          ...
          <div>
            <Button
              ...
              style={{ background: 'transparent', color: '#05195a' }}
          ...
          <div className="flex items-center gap-2">
            <input
              className={classNames(
                ...
                'font-bold h-[36px] placeholder-low-emphesis hover_shadow rounded px-2  max-w-[100px] focus:border-blue'
              )}
