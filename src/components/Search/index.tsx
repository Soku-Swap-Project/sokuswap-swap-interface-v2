...
const Search: FC<Search> = ({ term, search }) => {
  ...
  return (
    <div className="flex flex-grow items-center gap-4 w-full sm:w-auto">
      <div className="focus-within:ring-2 ring-blue flex flex-grow gap-2 items-center rounded border border-light-800 bg-dark-900 bg-opacity-50 py-2 px-3 w-full sm:w-auto">
