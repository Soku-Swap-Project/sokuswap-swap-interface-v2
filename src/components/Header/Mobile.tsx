...
import SlideOutMenu from 'app/components/SlideOutMenu/SlideOutMenu'
              ...
              <div className="fixed inset-y-0 left-0 pr-10 max-w-[260px] flex">
                ...
                >
                  <div className="w-screen max-w-sm">
                    <div className="flex flex-col h-full py-6 overflow-x-hidden overflow-y-scroll shadow-xl bg-light-800">
                      ...
                      <div className="flex flex-col gap-4 px-6">
                        ...
                        <div className="flex items-center justify-start gap-2">
                          <div className="flex items-center w-auto text-sm font-bold border-2 rounded shadow cursor-pointer pointer-events-auto select-none border-light-800 hover:border-dark-700 bg-dark-900 whitespace-nowrap">
