...
export default function LangSwitcher() {
  ...
  return (
    <Menu as="div" className="relative inline-block w-full text-left">
      <div>
        <Menu.Button className="w-full px-4 py-2 text-sm font-bold bg-transparent border-2 rounded shadow-sm text-primary border-light-800 hover:border-dark-700 bg-dark-1000">
