...
const FormTextField: FC<FormTextFieldProps> = ({
  ...
  return (
    <>
      ...
      >
        {icon && (
          <span className="inline-flex items-center px-3 rounded-l-md border border-r-0 border-light-800 sm:text-sm">
            {icon}
          </span>
        )}
        <input
        ...
        />
        {endIcon && (
          <span className="inline-flex items-center px-3 rounded-r-md border border-l-0 border-light-800 sm:text-sm">
            {endIcon}
          </span>
        )}
      </div>
