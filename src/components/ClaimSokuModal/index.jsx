...
export default function ClaimSokuModal() {
    ...
    const body = (
        ...
        <div className="modal_header">
            <h1 className="text-blue font-bold">Claim SOKU</h1>
    ...
    return (
        <div className="claimSoku__wrapper">
            <button type="button" className={isMobile ? 'claimSoku__navButton_mobile' : 'claimSoku__navButton' + " hover_shadow"} style={{ background: '#05195a', padding: '12px 24px', whiteSpace: 'nowrap', fontWeight: 700}} onClick={handleOpen}>
                Claim Soku
            </button>
