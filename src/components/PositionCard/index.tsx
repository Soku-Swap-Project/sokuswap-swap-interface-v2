      ...
      {({ open }) => (
        <div
          className={classNames(
            open ? 'bg-dark-900' : 'hover:bg-light-800',
        ...
        >
          ...
          >
            <Disclosure.Panel static>
              <div className="border border-light-800 rounded p-3">
                ...
                {userDefaultPoolBalance && JSBI.greaterThan(userDefaultPoolBalance.quotient, BIG_INT_ZERO) && (
                  <div className="flex justify-between border-t border-light-800 pt-3 mt-3">
