...
export const SOKU = new Token(ChainId.ETHEREUM, '0x4C3A8ECeB656Ec63eaE80a4ebD565E4887DB6160', 18, 'SOKU', 'Soku')
export const SUTEKU = new Token(ChainId.ETHEREUM, '0xc7230BADF274995F1933598c249c824fDE26F426', 18, 'SUTEKU', 'Suteku')
