...
export const SOKU = new Token(ChainId.BSC, '0x0e4B5Ea0259eB3D66E6FCB7Cc8785817F8490a53', 18, 'SOKU', 'Soku')
export const SUTEKU = new Token(ChainId.BSC, '0x198800aF50914004A9E9D19cA18C0b24587a50cf', 18, 'SUTEKU', 'Suteku')
