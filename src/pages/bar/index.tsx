          ...
          <div className="flex flex-col w-full max-w-xl mx-auto mb-4 md:m-0">
            ...
            <div>
              ...
              <div className="w-full max-w-xl px-3 pt-2 pb-6 rounded bg-dark-900 md:pb-9 md:pt-4 md:px-8">
                <div className="flex w-full rounded h-14 bg-light-800">
                  <div
                ...
                <Input.Numeric
                  ...
                  className={classNames(
                    'w-full h-14 px-3 md:px-5 mt-5 rounded bg-light-800 text-sm md:text-lg font-bold text-light-800 whitespace-nowrap caret-high-emphesis',
