...
export default function PoolFinder() {
  ...
  const prerequisiteMessage = (
    <div className="p-5 text-center rounded bg-light-800">{i18n._(t`Select a token to find your liquidity`)}</div>
  )
  ...
  return (
    <Container id="find-pool-page" className="py-4 space-y-6 md:py-8 lg:py-12" maxWidth="2xl">
      ...
      <div className="relative p-4 space-y-4 rounded bg-dark-900 shadow-liquidity">
          ...
          <AutoColumn justify="space-between">
            <AutoRow justify={'flex-start'} style={{ padding: '0 1rem' }}>
              <button className="z-10 -mt-6 -mb-6 rounded-full bg-dark-900 p-3px">
                <div className="p-3 rounded-full bg-light-800 hover:bg-dark-700">
                  <Plus size="32" />
                </div>
              </button>
            </AutoRow>
        ...
        {currency0 && currency1 ? (
          pairState === PairState.EXISTS ? (
            hasPosition && pair ? (
              ...
              <div className="p-5 rounded bg-light-800">
            ...
            <div className="p-5 text-center rounded bg-light-800">{i18n._(t`Invalid pair`)}</div>
          ) : pairState === PairState.LOADING ? (
            <div className="p-5 text-center rounded bg-light-800">
        ...
        {hasPosition && (
          <div className="rounded bg-light-800">
            <AutoColumn gap="sm" justify="center">
              <Button
                color="blue"
                fullWidth={true}
