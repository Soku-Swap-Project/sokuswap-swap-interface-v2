...
export const ALLOWED_PRICE_IMPACT_LOW_AS_NUMBER = 1 // 1%
export const ALLOWED_PRICE_IMPACT_MEDIUM_AS_NUMBER = 3 // 3%
export const ALLOWED_PRICE_IMPACT_HIGH_AS_NUMBER = 5 // 5%
// if the price slippage exceeds this number, force the user to type 'confirm' to execute
export const PRICE_IMPACT_WITHOUT_FEE_CONFIRM_MIN_AS_NUMBER = 10 // 10%
// for non expert mode disable swaps above this
export const BLOCKED_PRICE_IMPACT_NON_EXPERT_AS_NUMBER = 15 // 15%
