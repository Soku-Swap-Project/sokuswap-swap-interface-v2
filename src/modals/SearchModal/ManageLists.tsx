  ...
  return (
    <div
      ...
      className={classNames(
        ...
        'flex justify-between hover_shadow p-4 hover:bg-light-800/40'
      )}
      key={listUrl}
    >
      <div className="flex gap-3">
        ...
        <div className="flex flex-col">
          <Typography
            weight={700}
            className={classNames(isActive ? 'text-blue' : 'text-primary', 'overflow-hidden overflow-ellipsis')}
          >
            {list.name}{' '}
          ...
          <div className="flex items-center gap-1">
            ...
            <Popover
              ...
              content={
                <div className="flex flex-col gap-1 p-3 border rounded shadow bg-light border-dark-700">
            ...
            >
              <Settings size={12} className="cursor-pointer text-high-emphesis hover_shadow_icon" />
            </Popover>
          </div>
        </div>
      </div>
  ...
  return (
    <>
      <input
        ...
        className="w-full bg-light-800 hover_shadow border border-blue focus:border-blue rounded placeholder-secondary font-bold text-base p-4 appearance-none"
        value={listUrlInput}
      ...
      <div className="h-full overflow-y-auto bg-light border border-light-800 rounded overflow-hidden">
        <div className="flex flex-col flex-1 flex-grow divide-y divide-light-800">
