  ...
  return chainId === queryChainId ? (
    <div className="flex flex-col gap-4">
      <HeadlessUiModal.Header
        header={<h1 style={{ color: '#05195a' }}>Import Token</h1>}
        onClose={onDismiss}
        onBack={onBack}
      />
      <HeadlessUiModal.BorderedContent className="flex flex-col gap-4 hover_shadow divide-y divide-gray-700 !border-lightBlue/40">
        <Typography variant="sm" weight={700} className="text-lightBlue">
          {i18n._(
                ...
                <div className="flex flex-col">
                  <div className="flex items-center gap-2">
                    ...
                    {importList !== undefined ? (
                      ...
                      <Chip color="lightBlue" size="sm" label={i18n._(t`Unknown Source`)}>
      ...
      <Button
        ...
        className=".token-dismiss-button hover_shadow"
      >
        {i18n._(t`Import`)}
      </Button>
    </div>
