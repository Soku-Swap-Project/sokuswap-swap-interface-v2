...
const AuctionCard: FC<{ auction?: Auction; link?: boolean }> = ({ auction, link = true }) => {
  ...
  const content = (
    <div
      className="overflow-hidden bg-cover border rounded shadow-md cursor-pointer border-light-800 hover:border-dark-600"
    ...
    >
      <div className="bg-dark-900 relative flex flex-col gap-3 z-[10]">
              ...
              <div
                className={classNames(
                  auction.status === AuctionStatus.LIVE
                    ...
                    ? 'bg-pink'
                    : 'bg-blue',
                  'absolute top-[-2px] right-[-2px] rounded-full w-3.5 h-3.5 shadow-md shadow-light-800 z-10'
                )}
              />
              <Image
                alt="logo"
        ...
        <div className={classNames('flex items-center justify-between p-3 bg-light-800')}>
        ...
        <div className="flex flex-col">
          ...
          <div className={classNames('flex flex-col flex-grow px-3 px-4 py-2 divide-y bg-light-800 divide-dark-700')}>
