  ...
  return (
    <div className="flex gap-2 items-center">
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button className="w-full px-4 py-2.5 text-sm font-bold bg-transparent border rounded shadow-sm text-primary border-light-800 hover:bg-dark-900">
        ...
        >
          <Menu.Items
            static
            className="w-full absolute rounded mt-2 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none border border-light-800 bg-dark-1000 shadow-md"
          >
